"""Command line interface for the VoiceBreaker application."""
import asyncio
import logging
...
def main(prompt_file: Path, verify: bool) -> None:
    ...
    Args:
        prompt_file: Path to the jailbreak prompt file.
        verify: Whether to verify jailbreak results before forwarding mic.
    """
